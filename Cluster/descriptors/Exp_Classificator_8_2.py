...
from sklearn.model_selection import StratifiedGroupKFold, KFold, train_test_split, GridSearchCV
...
output_path = '/home/ccriado/CVC/Colon_CVC/Cluster/fold_results_stratified.csv'
